...
\todo[inline]{This work was planned for submission as a research paper
  I came across an independent work \cite{kolar2014graph} on the
  \texttt{arXiv} that proposes nearly the same approach for the
  Graphical Lasso. The difference here is to consider the framework of
  neighborhood selection approach. We should mention this at some
